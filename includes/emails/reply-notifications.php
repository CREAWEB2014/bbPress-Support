...
/**
 * Email Reply Customizations
 *
 * Originally from "bbPress Custom Topic & Reply Notifications
 * http://pippinsplugins.com/bbpress-custom-reply-notifications
 *
 * Original Author Pippin Williamson
 */

class WI_BBP_Topic_Reply_Notifications {
...
// load our class
$GLOBALS['pw_bbp_topic_reply_notifications'] = new WI_BBP_Topic_Reply_Notifications();
