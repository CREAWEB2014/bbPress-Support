...
function give_bbp_dashboard_shortcode( $atts, $content = null ) {
			...
			<?php foreach ( $mods as $mod ) : ?>
				...
				<div class="mod col-xs-6 col-sm-3">
					...
					<div class="mod-ticket-count">
						<a href="<?php echo add_query_arg( 'mod', $mod->ID ); ?>" class="label label-default">Tickets:
							<strong><?php echo $ticket_count; ?></strong></a>
					</div>
				</div>
	...
	<ul class="nav nav-tabs" id="support-tabs">
		<li>
			<a href="#your-waiting-tickets" data-toggle="tab">Awaiting Your Response (<?php echo $waiting_tickets->post_count; ?>)</a>
		</li>
		<li>
			<a href="#your-tickets" data-toggle="tab">Your Open Tickets (<?php echo $assigned_tickets->post_count; ?>)</a>
		</li>
		<li>
			<a href="#unassigned" data-toggle="tab">Unassigned Tickets (<?php echo $unassigned_tickets->post_count; ?>)</a>
		</li>
		<li><a href="#no-replies" data-toggle="tab">No Replies (<?php echo $no_reply_tickets->post_count; ?>)</a></li>
		<li>
			<a href="#unresolved" data-toggle="tab">Unresolved Tickets (<?php echo $unresolved_tickets->post_count; ?>)</a>
		</li>
